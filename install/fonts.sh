...
if [ -z "$OMARCHY_BARE" ]; then
  paru -S --noconfirm --needed ttf-font-awesome noto-fonts noto-fonts-emoji noto-fonts-cjk noto-fonts-extra
else
  paru -S --noconfirm --needed ttf-font-awesome noto-fonts noto-fonts-emoji
fi
